...
# Impute raw data 
train <- read.csv("~/Desktop/train.csv",stringsAsFactors=T)
SalePrice = train$SalePrice
test <- read.csv("~/Desktop/test.csv",stringsAsFactors=T)
...
RMSE_LASSO #0.01825552

#####Regression Trees RMSE= 0.222; Random Forest RMSE= 0.138; Ridge RMSE~0.01708521; Lasso RMSE~0.01825552.#####
```
